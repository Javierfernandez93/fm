...
<body class="g-sidenav-show bg-light">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs fixed-start p-2" id="sidenav-main">
        <div class="bg-primary rounded rounded-2 pb-5">
                                ...
                                <?php if(false) { ?>
                                    <li class="nav-item">
                                        <a class="nav-link " href="../../apps/store/creditPackage">
                                            <span class="sidenav-mini-icon"> F7 </span>
                                            <span class="sidenav-normal"> Ofertas créditos <span class="badge ms-2 bg-danger">New</span></span>
                                        </a>
                                    </li>
                                <?php } ?>
                                <li class="nav-item ">
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl <?php if ($floating_nav === true) { ?>bg-transparent position-absolute floating-nav w-100 z-index-2<?php } ?>">
            <div class="container py-3 mb-3">
                <nav aria-label="breadcrumb">
                    <h6 class="fs-3 font-weight-bolder ms-2"><?php echo JFStudio\Router::getName($route); ?></h6>
                </nav>
                <?php if ($UserLogin->_loaded) { ?>
    ...
    <script src="../../src/js/constants.js?v=2.1.7" type="text/javascript"></script>
    <script src="../../src/js/alertCtrl.js?v=2.1.7" type="text/javascript"></script>
    <script src="../../src/js/jquery-3.5.1.min.js" type="text/javascript"></script>
    <script src="../../src/js/general.js?v=2.1.7" type="text/javascript"></script>
    <!-- Github buttons -->
    ...
    <script src="../../src/js/soft-ui-dashboard.min.js?v=2.1.7"></script>
    
    <script src="../../src/js/vue.js?v=2.1.7" type="text/javascript"></script>
