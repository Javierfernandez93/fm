...
{	
	...
	public static function getVarFromInstance($_instance_id = null,$var_name = null)
	{
 	...
 	{	
		...
		if(isset($instance_id) === true && is_string($instance_id))
		{
			...
			self::$instances[$instance_id] = self::$instances[$instance_id] ?? false;
	...
	public function getKeyInstancesLastKey()
	{
 	...
 	public function _addItem($Item = null,int $quantity = null,$additional_fields = null,bool $search = true)
 	{
 		$this->loadSessionInstance();
	...
	public static function getInstancesUnique()
 	...
 	public function addItem($Item = null,int $quantity = 1,$additional_fields = null,bool $search = true)
 	{
 		if(isset($Item) === true) {	
