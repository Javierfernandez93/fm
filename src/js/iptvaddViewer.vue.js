                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-12 mb-3">
                                    <div class="form-floating">
                                        <input :autofocus="true" v-model="client.name" @keydown.space.prevent :class="client.name.secureUser() ? 'is-valid' : ''" @keypress.enter.exact="$refs.whatsapp.focus()" type="text" class="form-control" id="name" placeholder="name@example.com">
