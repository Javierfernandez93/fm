...
const StoreitemsViewer = {
    ...
    template : `
        <div v-if="items">
            <ul class="list-group">
                <li v-for="item in items" class="list-group-item list-group-item-action f-zoom-element-sm">
                    <div class="row align-items-center"
                        :class="!item.aviable ? 'opacity-50' : ''">
                        <div class="col-auto">
                        ...
                        <div class="col-auto" v-if="item.aviable">
                            ...
                            <span class="text-end">
                                <div>Precio</div>
                                <div class="h3">USD $ {{item.amount.numberFormat(2)}}</div>
                            </span>
