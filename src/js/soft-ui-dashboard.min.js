...
function toggleSidenav() {
    body.classList.contains(className)
        ...
        : (body.classList.add(className), sidenav.classList.add("bg-dark"), sidenav.classList.remove("bg-transparent"), iconSidenav.classList.remove("d-none"));
}
...
function navbarColorOnResize() {
    1200 < window.innerWidth
        ...
        : (sidenav.classList.add("bg-dark"), sidenav.classList.remove("bg-transparent"));
}
